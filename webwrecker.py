...
def display_banner():
    ...
    f = Figlet(font='slant')
    banner = f.renderText('WebWrecker')
    print(Fore.MAGENTA + banner)
    print(Fore.MAGENTA + "Developed By - Shashwat Singhal")
...
def main():
    ...
    if choice == '1':
        ...
        pass_file = r"D:/GIT/WebWrecker/credentials/pass.txt"
        user_file = r"D:/GIT/WebWrecker/credentials/user.txt"
    ...
    print(Fore.CYAN + "Thank you for using the tool. Stay updated on github.com/Shashwat1218/WebWrecker" + Style.RESET_ALL)
